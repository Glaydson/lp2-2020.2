...
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (1,'Sobre Mouses e Homens', '1954-11-08', 100, 11.00, 1);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (2,'Um Estranho no Ninho', '1973-11-08', 200, 15.00, 1);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (3,'Por Quem os Sinos Dobram', '1932-11-08', 100, 13.00, 2);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (4,'Guerra e Paz', '1955-11-08', 140, 15.00, 3);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (5,'As Vinhas da Ira', '1955-11-08', 300, 16.00, 4);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (6,'Padrões de Design', '1996-11-08', 180, 14.00, 5);
insert into tb_livros(livro_id, titulo, data_publicacao, numero_paginas, preco, editora_id) values (7,'Um Conto de Duas Cidades', '1943-11-08', 400, 15.00, 6);
