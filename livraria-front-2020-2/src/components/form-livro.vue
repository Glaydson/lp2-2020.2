    ...
    <div class="card-body">
      <form novalidate>
        <div class="form-group row mb-2">
          <label class="col-md-2 col-form-label" for="idTitulo">Título</label>
          <div class="col-md-8">
            <input
              class="form-control"
              id="idTitulo"
        ...
        <div class="form-group row mb-2">
          <label class="col-md-2 col-form-label" for="idData"
        ...
        <div class="form-group row mb-2">
          <label class="col-md-2 col-form-label" for="idPreco">Preço</label>
        ...
        <div class="form-group row mb-2">
          <label class="col-md-2 col-form-label" for="idNumeroPaginas"
        ...
        <div class="form-group row mb-2">
          <label class="col-md-2 col-form-label" for="autores">Autores</label>
          <div class="col-md-8">
            <select
              multiple
              class="form-control"
...
export default {
  ...
  methods: {
    ...
    salvarLivro() {
      // Somente é atualizado ao clicar no botão Salvar
